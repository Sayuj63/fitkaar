document.addEventListener('DOMContentLoaded', () => {
    ...
    // Fixed positions and sizes for each sticker
    // EDIT HERE: Change 'width' to adjust the size of each sticker separately
    const stickerConfig = {
        'camera_sticker.png': { top: '70%', left: '46%', width: '18%' }, // Top Center (Neck)
        'chai_sticker.png': { top: '54%', left: '60%', width: '18%' }, // Right side
        'football_sticker.png': { top: '52%', left: '46%', width: '25%' }, // Left side
        'guitar_sticker.png': { top: '60%', left: '66%', width: '40%' }, // Right side vertical
        'mountain_sticker.png': { top: '70%', left: '58%', width: '15%' }, // Top Center (Shoulders)
        'pasta_sticker.png': { top: '64%', left: '58%', width: '15%' }, // Center
        'quote_sticker.png': { top: '62%', left: '49%', width: '12%' }, // Center Text
        'ticket_sticker.png': { top: '55%', left: '52%', width: '12%' } // Bottom Left
    };
    ...
    function renderStickers() {
        ...
        activeStickers.forEach(filename => {
            ...
            img.style.width = '100%'; // Fits the container width defined in stickerConfig
